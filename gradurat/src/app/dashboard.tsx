        ...
        <View style={styles.cardTitleRow}>
          <View style={styles.flex}>
            ...
            <Text style={styles.muted}>
              {item.employers?.company_name || "Employer"} ·{" "}
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!id)
          throw new Error("Register a profile before opening the dashboard.");
          ...
          <View style={styles.user}>
            ...
            <View>
              <Text style={styles.userName}>
                {name || (isStudent ? "Graduate" : "Employer")}
              </Text>
              <Text style={styles.muted}>
                {isStudent ? "Job Seeker" : "Employer"}
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.welcome}>
            <View style={styles.flex}>
              <Text style={styles.smallTitle}>
                {isStudent ? "GRADURAT AI" : "EMPLOYER PORTAL"}
              </Text>
              <Text style={styles.heading}>
                {isStudent ? (
                  <>
                    Welcome back,{" "}
                    <Text style={styles.blue}> {name || "Graduate"}.</Text>
                  </>
                ) : (
                  <>
          ...
          {state === "error" ? (
            ...
            <View style={styles.list}>
              <View style={styles.sectionHeading}>
                <View>
                  <Text style={styles.smallTitle}>
                    {isStudent ? "AI POWERED" : "GRADURAT AI"}
                  </Text>
              ...
              {isStudent && opportunities.length === 0 && (
                <Text style={styles.muted}>
                  No matching opportunities yet. Check back soon.
                </Text>
              )}
