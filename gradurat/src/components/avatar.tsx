...
const styles = StyleSheet.create({ wrap: { alignItems: 'center', gap: 6 }, image: { width: 64, height: 64, borderRadius: 32 }, fallback: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.blue }, initials: { color: colors.text, fontWeight: '800' }, actions: { flexDirection: 'row', gap: 12 }, action: { color: '#7daeff', fontSize: 12, fontWeight: '700' }, remove: { color: colors.danger, fontSize: 12, fontWeight: '700' }, message: { color: colors.muted, fontSize: 11, maxWidth: 170, textAlign: 'center' } });